...
- **Available Methods:**
  ...
  * `add_inventory` (constant: `ADD_INVENTORY`)
  * `remove_inventory` (constant: `REMOVE_INVENTORY`)
  * `get_inventory_count` (constant: `GET_INVENTORY_COUNT`)

---

# **Move Contract: `contract/inventorytracker/sources/inventorytracker.move`**
  ...
  return (
    <div style={{ minHeight: "100vh", padding: "1rem", background: "var(--gray-a2)" }}>
      <Container style={{ maxWidth: "800px", margin: "0 auto" }}>
        <Heading size="6" style={{ marginBottom: "2rem" }}>IOTA Inventory Tracker dApp</Heading>
            ...
            {state.isLoading && !data ? (
              ...
              <div>
                <div style={{ marginBottom: "1rem", padding: "1rem", background: "var(--gray-a3)", borderRadius: "8px" }}>
                  <Text size="2" style={{ display: "block", marginBottom: "0.5rem" }}>Inventory Count</Text>
...
- Use Package ID: `0x9d108e915e632cfa98fa2e1a1f1380caf12aefad9c3f2bef9ccc354686adc37d` and Module: `contract`
